...
<div id="slider">
	...
	<div id="l1">
	 <label>
	  <input name="contact" type="submit" id="contact" value="Contact" style="background-color:#726E6D;color:#FFF;height:25px;width:70px; border-radius:5px 5px 0px 0px; border:2px solid #999999; font-family:Calibri;font-size:16px; margin-left:20px; margin-top:5px;">
	  </label>
	  
	</div>
	<div id="l2" style="border:thick #726E6D solid ; border-radius:5px 5px 5px 5px; width:290px; padding-left:10px; padding-right:10px; height:330px; padding-top:30px; " >
	  <div align="justify"><font color="#FFF" size="+1" style="font-family:"Monotype Corsiva" ">
	    Mr. Sumit Yadav </br>
		Project Manager </br>
		9783627453 </br>
		sumit.yadav@ codex.co.in </br>
		Codex Infosolutions Pvt Ltd. </br>
		Jaipur
	    </font>
	    </div>
	</div>
