	...
	if(isset($_POST['submit']))
	{
	  ...
	  if($num>0)
	  {
	  	if(isset($_POST['chk1']))
		{
			...
			SetCookie('passwrd',"$password",time()+60);
...
<div id="slider">
    ...
    <form id="form1" method="post" action="" >
	  <label>
	  <input name="signin" type="submit" id="signin" value="Sign-In" style="background-color:#726E6D;color:#FFF;height:25px;width:70px; border-radius:5px 5px 0px 0px; border:2px solid #999999; font-family:Calibri;font-size:16px; margin-left:20px; margin-top:5px;">
	  </label>
	  <label>
	  <input name="signup" type="submit" id="signup" value="Sign-Up" style="background-color:#FFF;color:#000;height:25px;width:70px; border-radius:5px 5px 0px 0px; border:2px solid #999999; font-family:Calibri;font-size:16px; margin-left:5px; margin-top:5px;">
	  </label>
      </form>
	</div>
...
if(isset($_SESSION['user']))
{
?><div style="margin-top:50px;margin-left:30px;"><font color="#21BECB" size="+1"><i><b>Welcome <?php echo $_SESSION['user']; ?></b></i></font> 
	</div>
<?php
}	
else
...
<form id="f2" method="post" action="" onSubmit="return doValidate();">
	...
	<div id="username" ><input type="text" name="username1" placeholder="username" size="30" style="border:2px solid #726E6D;     background-color:#F7F7F7;color:#726E6D;height:25px;" id="username1" value="<?php if(isset($_COOKIE['user'])) echo $_COOKIE['user'];?>" /><label id="catname" style="color:#FF0000"></label> </div>
	
	<div id="password">
      <input name="password1" type="password" style="border:2px solid #726E6D;background-color:#F7F7F7;color:#726E6D;height:25px;" size="30"  placeholder="password" id="password1" value="<?php if(isset($_COOKIE['passwrd'])) echo $_COOKIE['passwrd'];?>" /><label id="catname1" style="color:#FF0000"></label>
    </div>
	
	<div id="forgot">
	<div style="height:20px;width:210px; float:left;"><a href="forgot.php"  style="text-decoration:none"><font color="#FFF" style=" font-size:16px;font-family:"Calibri" ">Forgot Password ??</font></a></div>
    </div>
	<div id="remember">
	<input name="chk1" type="checkbox" id="chk1" value="Remember Me" ><font color="#FFF" style=" font-size:16px;font-family:"Calibri" ">Remember Me</font>
	</input> <label id="msg" style="color:#FF0000"><?php if(isset($msg)) echo $msg; ?></label>
	</div>
    
	<div id="btn">
    	<input type="submit" name="submit" id="submit" value="Sign In" style="background-color:#726E6D;color:#FFF;height:25px;width:70px; border-radius:5px 5px 5px 5px; border:2px solid #999999; font-family:Calibri;font-size:16px;" />
