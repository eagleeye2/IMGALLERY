...
<div id="slider">
	...
	<div id="aa"><form id="form1" method="post">
	 <label>
	  ...
	  <label>
	  <input name="viewfeed" type="submit" id="viewfeed" value="View All" style="background-color:#726E6D;color:#FFF;height:25px;width:70px; border-radius:5px 5px 0px 0px; border:2px solid #999999; font-family:Calibri;font-size:16px; margin-left:20px; margin-top:5px;">
	  </label></form>
	</div> 
