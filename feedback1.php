...
if(isset($_SESSION['user']))
{
	...
	if(isset($_POST['submit']))
	{
		...
		$query="insert into feedback value(NULL,'$username','$comment')";
...
<link rel="stylesheet" href="home_gal.css" type="text/css">
 ...
 function doValidate()
 {
  ...
  var pass=document.getElementById("comment").value;
	...
	if(pass==" " || pass.length==0)
  {
   ...
   document.getElementById("comment1").innerHTML="comment is empty!!";
   return false;
   }
...
<div id="logout"><font color="#21BECB" size="+1"><i><b>Welcome <?php echo $_SESSION['user']; ?></b></i></font> 
...
<div id="slider">
	...
	<div id="aa"><form id="form1" method="post">
	 <label>
	  ...
	  <label>
	  <input name="viewfeed" type="submit" id="viewfeed" value="View All" style="background-color:#FFF;color:#000;height:25px;width:70px; border-radius:5px 5px 0px 0px; border:2px solid #999999; font-family:Calibri;font-size:16px; margin-left:5px; margin-top:5px;">
	  </label>
      </form>
	</div>
	...
	<div style="height:30px;width:90px; float:left;margin-top:70px;margin-left:10px; "><a href="#"  style="text-decoration:none"><font color="#FFF" style=" font-size:16px;font-family:"Calibri" ">Comment</font></a></div>
	<div style="height:130px;width:190px; float:left;margin-top:70px; ">
	  <textarea name="comment" id="comment" type="text" style="border:2px solid #726E6D;     background-color:#F7F7F7;color:#726E6D;height:120px;" value="" ></textarea><label id="comment1" style="color:#FF0000"></label>
